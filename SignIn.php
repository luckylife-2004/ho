<?php
	...
	if (isset($_POST['dangnhap'])) 
	{
		...
		{        				
			echo "<script>alert('Tên đăng nhập này không tồn tại. Vui lòng kiểm tra lại. '); window.location.href='/duy';</script>";	
        	exit;
    	}	
		...
		{        
			echo "<script>alert('Mật khẩu không đúng. Vui lòng nhập lại.'); window.location.href='/duy';</script>";	
        	exit;
    	}
